...
import java.util.*;
class Runner{
    String name;// the name of the runner
    int time;// the time the runner took to complete the marathon
    
    //the constructor to intialise the runner's name and time taken to complete the marathon
...
public class VU_BostonMarathon {
    public static void main(String[] args) {
        //creating a list to add all runners
